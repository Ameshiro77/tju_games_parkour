...
execute as @a[x=-6,y=19,z=2,dx=0,dz=-4,dy=1] run scoreboard players set @s tick_player 0
execute as @a[x=-6,y=19,z=2,dx=0,dz=-4,dy=1] run scoreboard players set @s time_player 0
execute as @a[x=-6,y=19,z=2,dx=0,dz=-4,dy=1] run function tju_parkour:team/team_rank
