...
execute as @a[x=-14,y=21,z=0,dx=0,dy=1,dz=0] run scoreboard players operation @s start = #time time
execute as @a[x=-14,y=21,z=0,dx=0,dy=1,dz=0] run tp @s -37 23 0